...
function buildDirectSkillRequirement(body = {}) {
  ...
  return [
    ...
    '- 本次任务必须在执行人本机 Codex 环境中运行，使用执行人自己电脑上的 Codex、工具配置、网络、代理和本机授权。',
    '- 如果本次需要 gpt-image-2 / image2 / GPT Image 2，也必须使用执行人自己电脑上的 Codex / OpenAI 凭据、环境变量、代理和网络；平台服务器、负责人电脑和工作台管理者账号不得代跑或代用密钥。',
    '- 平台不提供 Figma token 或 gpt-image2 / OpenAI API Key；如果本机 Figma MCP 未授权、缺少写入工具、没有 Figma 权限，或本机 gpt-image2 / Image2 连接、额度、地区、代理不可用，必须停止并回传阻塞原因。',
