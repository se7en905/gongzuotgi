  ...
  >
    <div class="ai-score-rule-dialog__content">
      ...
      <section class="ai-score-rule-dialog__section ai-score-rule-dialog__section--file">
        <h4>8. 负责人配置表</h4>
        <p>这里就是当前真实参与 AI 计分的配置文件，说明注释也已经直接写进这一个文件里了。</p>
        <p>以后只要打开这份文件改数字，再回工作台点“刷新评分”，组员分数就会按新参数重新计算，不需要再对照第二份说明文件。</p>
      ...
      return [
        ...
        },
        {
          ...
          lines: [
            ...
            '负责人自己执行的任务，对应 skill/md 的使用不再给组员加分；独立口径成员按本人闭环使用和覆盖率计算。'
          ]
        },
        {
          title: '5. 执行分怎么给',
          lines: [
            ...
            '负责人自己执行的任务，不给组员记对应执行分；独立口径成员同样更强调真实执行活跃度，而不是只看产物堆积。'
          ]
        },
        {
          title: '6. 负责人怎么看这个分',
        ...
        },
        {
          title: '7. 整合型产物怎么判',
          lines: [
            '如果一个新产物只是把多个已有 Skill 或规范打包成一个入口，但没有形成新的独立执行层，主要记使用分和执行分，不按高价值新产物直接加分。',
            '如果整合后形成了独立可复用的新入口，可记 1 个新产物；被整合进去的原有产物产品分仍归原作者，不因为被引用或组合而转移。'
          ]
        }
      ];
    },
